...
class SyntheticEventSequenceStream(Dataset):
    def __init__(self, processed_input_path, data_path, cfg, split, is_train, augmentation, frame_offset, total_frames=None):
        super().__init__()
