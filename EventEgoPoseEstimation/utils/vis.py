...
def save_batch_image_with_joints(self, batch_image, batch_joints, batch_joints_vis,
                                 tag, global_step, nrow=8, padding=2, n_images=4):
    '''
    batch_image: [batch_size, channel, height, width]
...
def save_batch_heatmaps(self, batch_image, batch_heatmaps, tag, global_step, 
...
def save_debug_segmenation(self, config, inp, meta, gt_seg, pred_seg, prefix, global_step):
